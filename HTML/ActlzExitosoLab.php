...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("UPDATE EquipoLaboratorio SET marca = ?, modelo = ?, serie = ?, descripcionLarga = ?, descripcionCorta = ?, claveProveedor = ?, fechaAdquisicion = ?, garantia = ?, vigenciaGarantia = ?, ubicacion = ?, responsable = ?, estado = ?, tipogarantia = ?, farinografo = ? WHERE claveEquipo = ?");
